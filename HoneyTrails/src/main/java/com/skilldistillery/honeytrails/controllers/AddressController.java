...
public class AddressController {
	...
	@PostMapping("address")
	public Address createAddress(@RequestBody Address address, HttpServletResponse res, Principal principal) {
		Address newAddress = addressSer.addAddress(address, principal.getName());
		if(newAddress == null) {
			res.setStatus(400);
		} else {
			res.setStatus(201);
