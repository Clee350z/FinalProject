...
INSERT INTO `trail` (`id`, `name`, `location`, `length_miles`, `picture_url`, `trail_open`, `latitude`, `longitude`, `difficulty_id`) VALUES (5, 'Redwood Creek Trail', 'California', 15.6, 'https://i0.wp.com/www.thehikinglife.com/the-hiking-life-2/wp-content/uploads/2021/09/PHOTO-2021-09-14-15-10-36.jpg?ssl=1', 1, 41.299, 124.033, 5);
